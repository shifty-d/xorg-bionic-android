...
/* Default font path */
#define COMPILEDDEFAULTFONTPATH X4DROID_DATADIR "/usr/share/fonts/misc/," X4DROID_DATADIR "/usr/share/fonts/TTF/," X4DROID_DATADIR "/usr/share/fonts/OTF/," X4DROID_DATADIR "/usr/share/fonts/Type1/," X4DROID_DATADIR "/usr/share/fonts/100dpi/," X4DROID_DATADIR "/usr/share/fonts/75dpi/"

/* Miscellaneous server configuration files path */
#define SERVER_MISC_CONFIG_PATH X4DROID_DATADIR "/usr/lib/xorg"
...
/* Overall prefix */
#define PROJECTROOT X4DROID_DATADIR "/usr"
...
/* sysconfdir */
#define SYSCONFDIR X4DROID_DATADIR "/usr/etc"
