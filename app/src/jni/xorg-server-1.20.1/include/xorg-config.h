...
#define DEFAULT_MODULE_PATH X4DROID_DATADIR "/usr/lib/xorg/modules"

/* Path to installed libraries. */
#define DEFAULT_LIBRARY_PATH X4DROID_DATADIR "/usr/lib"

/* Default log location */
#define DEFAULT_LOGDIR X4DROID_DATADIR "/usr/var/log"
